...
1. **Authorisation:** Only event author can request deletion
...
3. **Gift Wrapping (NIP-59):** Encrypt sealed rumours
...
[← Back to Reference](../index.md) | [← Back to Developer Documentation](../index.md)
